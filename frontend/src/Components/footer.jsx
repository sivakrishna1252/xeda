...
export default function Footer() {
  ...
  return (
    <>
      ...
      <a
        href="https://wa.me/919172266069"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
        className={`fixed right-6 w-11 h-11 rounded-full
          bg-green-500 hover:bg-green-600 text-white
          flex items-center justify-center shadow-lg
          transition-all duration-300
          hover:scale-110 hover:shadow-green-500/40
          z-[9999]
          ${showTopBtn ? "bottom-20" : "bottom-6"}`}
      >
      ...
      {showTopBtn && (
        <button
          ...
          className="fixed bottom-6 right-6 w-11 h-11 rounded-full
      ...
      <footer className="bg-gradient-to-b from-black/80 to-black/90 backdrop-blur-sm text-gray-300 mt-8 border-t border-gray-800/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-6">
            ...
            {/* Contact Info */}
            <div className="grid grid-cols-[28px_1fr] gap-x-3 gap-y-3 text-sm">
              ...
              >
                City Vista Kharadi, Pune - 411048
              </a>
            </div>
          </div>
          ...
          <p className="text-xs text-gray-500 text-center">
            ...
            <span className="text-green-400 font-medium">XedaFarm</span>. All
            rights reserved.
          </p>
        </div>
      </footer>
